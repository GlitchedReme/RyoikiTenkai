...
public class SmokeParticleEffect extends AbstractGameEffect {
    private float x;
    ...
    public SmokeParticleEffect(float x, float y, float scale) {
        ...
        this.vel = MathUtils.random(0.0F * Settings.scale, 1.5F * Settings.scale);
    }
