...
public class DemonFormFlashEffect extends AbstractGameEffect {
    ...
    public DemonFormFlashEffect() {
        ...
        this.color = new Color(1.0F, 0.1F, 0.1F, 1.0F);
    ...
    public void update() {
        ...
        if (this.duration > this.startingDuration - 0.5F) {
            ...
            this.color.a = Interpolation.fade.apply(MathUtils.clamp(progress, 0.0F, 1.0F));
    ...
    public void render(SpriteBatch sb) {
        ...
        shader.setUniformf(ShaderManager.heatWaveAmplitude, 0.02F);
