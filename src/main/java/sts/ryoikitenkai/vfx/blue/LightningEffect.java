...
public class LightningEffect extends AbstractGameEffect {
    ...
    public LightningEffect(float x, float y, float scale) {
        this.renderBehind = MathUtils.randomBoolean();
        this.x = x + MathUtils.random(-150f, 150f) * Settings.scale;
        this.y = y + MathUtils.random(-100f, 100f) * Settings.scale;
        this.color = Settings.LIGHT_YELLOW_COLOR.cpy();
        this.img = ImageMaster.LIGHTNING_PASSIVE_VFX.get(this.index);
        this.scale = MathUtils.random(0.6F, 1.0F) * scale * Settings.scale;
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(this.img, this.x - 61.0F, this.y - 61.0F, 61.0F, 61.0F, 122.0F, 122.0F, this.scale, this.scale, this.rotation, 0, 0, 122, 122,
