...
public class StormParticleEffect extends AbstractGameEffect {
    private float x;
    private float y;
    ...
    public StormParticleEffect(float x, float y, float scale) {
        ...
        this.x = x + MathUtils.random(-120.0F * Settings.scale, 120.0F * Settings.scale) * scale - this.img.packedWidth / 2.0F;
        this.y = y + MathUtils.random(-60.0F * Settings.scale, 60.0F * Settings.scale) * scale - this.img.packedHeight / 2.0F;
        this.scale = 0.01F;
